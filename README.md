> React ecosystem has evolved, a lot of great packages and tools have been build and this package is not needed anymore.   

![ackee|lucas](./assets/ackee_git_frontend_lucas_deprecated.png)
