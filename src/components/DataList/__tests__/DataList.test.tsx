...
describe('DataList', () => {
    ...
    const data = [{ id: 'row1' }, { id: 'row2' }, { id: 'row3' }, { id: 'row4' }];
    const noDataMessage = 'Nejsou data';

    it('should render all rows if RowComponent is component', () => {
        const wrapper = shallow(<DataList {...{ data, RowComponent, noDataMessage }} />);
    ...
    it('should render all rows if RowComponent is element', () => {
        const wrapper = shallow(<DataList data={data} RowComponent={<RowComponent />} noDataMessage="" />);
    ...
    it('should supply index in list into each component', () => {
        const wrapper = shallow(<DataList {...{ data, RowComponent, noDataMessage }} />);
        const wrapper2 = shallow(<DataList data={data} RowComponent={<RowComponent />} noDataMessage="" />);
    ...
    it('should use scrollbars in default', () => {
        const list = shallow(<DataList {...{ data, RowComponent, noDataMessage }} />);
